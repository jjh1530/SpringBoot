...
<script>
	$(document).ready(function(){
		...
		$("a").on("click",function(e){
			e.preventDefault();
			var idx = $(this).attr("href"); // href의 값
			$.ajax({
				url : "${cpath}/get",
				type : "get",
				data : {"idx":idx},
				...
				<div class="card" style="min-height: 500px; max-height: 1000px">
					<div class="card-body">
						...
						<form action="">
							...
							<div class="form-group">
								<label for="memePwd">아이디</label>
								<input type="password" class="form-control" id="memePwd" name="memePwd"/>
							</div>
					...
					<div class="card-body">
						<form id="regForm" action="${cpath}/register" method="post">
							...
							<div class="form-group">
								...
								<input type="text" class="form-control" id="writer" name="writer" placeholder="writer" placeholder="writer"/>
							</div>
							<div id="regDiv">
